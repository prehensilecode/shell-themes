...
source "$OSH/custom/themes/powerline-multiline-spack/powerline-multiline-spack.base.sh"
...
SPACK_ENV_CHAR=${POWERLINE_PYTHON_VENV_CHAR:="❲s❳ "}
SPACK_ENV_THEME_PROMPT_COLOR=22
...
POWERLINE_LEFT_PROMPT=${POWERLINE_LEFT_PROMPT:="scm python_venv spack_env ruby cwd"}
